#!/usr/bin/env bash
# Train the predicted-best config: all modules on, future_pred kept,
# posterior + surprise + contrastive losses zeroed out.
set -euo pipefail
...
NAME="future_pred_only"
DESC="All modules + future_pred losses; posterior=0 surprise=0 contrastive=0"
...
print(f"{'='*50}")
print(f"  Previous bests:")
print(f"    no_aux_losses : 0.3765")
print(f"    no_posterior  : 0.3697")
print(f"    full_model    : 0.3620")
PYEOF
